...
// Protocol parsing implementation, included by runtime_tiles.h after its shared
// model and UI callbacks are declared. No additional configuration is retained.

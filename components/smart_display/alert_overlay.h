...
struct Alert {
  ...
  std::string button2;  // the second button (firmware 0.3.5+, show_alert_choice); empty: the card has one button
...
// The buttons along the bottom of the card (firmware 0.3.5+). One button stands against the right edge, as it always did.

...
# A live picture on a 1x2 or 2x2 tile fills the card (app 0.3.9, firmware 0.3.4): cut to fill it or whole on black, with
...
def validate_layout(data, stored=False, grid=DEFAULT_GRID):
    ...
    for tile in tiles:
        ...
        if 'options' in tile:
            ...
            # So does how its picture fills a taller card and whether its name is on it (app 0.3.9); the defaults are

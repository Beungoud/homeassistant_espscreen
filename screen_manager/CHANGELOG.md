...
- Needs firmware 0.2.80: press **Update** on the screen. Includes everything from 0.2.92. CYD firmware: 1,622,624 bytes, 88.4 % of the update slot (11,136 bytes less than 0.2.92: the thermostat overlays left the YAML), built with the ESPHome this add-on ships (2026.9.0).

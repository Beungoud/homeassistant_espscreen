...
- **A page can say something else at the top than the screen does.** The title at the top is the screen's, on every page, which is what most screens want. Give a page a title of its own and that page says it; leave it empty and the page hands the bar back to the screen's title. In the editor it sits in the top-bar inspector, under the screen's own name, and the mockup's bar follows it while you type. On a screen where nobody set one, nothing changes and nothing is paid for the possibility.
